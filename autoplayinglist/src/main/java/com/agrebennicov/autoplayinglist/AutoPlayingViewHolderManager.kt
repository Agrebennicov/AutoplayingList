...
/**
 * AutoPlayingViewHolderCreator manages view types and creates holders based on it's result
 */
abstract class AutoPlayingViewHolderManager<T : AutoPlayingViewModel> {
